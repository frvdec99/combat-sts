...
#ifndef COMBAT_STS_MONSTERENCOUNTER_H
#define COMBAT_STS_MONSTERENCOUNTER_H
...
namespace StS {
    ...
    static constexpr bool isBossEncounter(MonsterEncounter e) {
        return e == MonsterEncounter::SLIME_BOSS ||
               e == MonsterEncounter::HEXAGHOST ||
               e == MonsterEncounter::THE_GUARDIAN ||
               e == MonsterEncounter::CHAMP ||
               e == MonsterEncounter::COLLECTOR ||
               e == MonsterEncounter::AUTOMATON ||
               e == MonsterEncounter::DONU_AND_DECA ||
               e == MonsterEncounter::TIME_EATER ||
               e == MonsterEncounter::AWAKENED_ONE ||
               e == MonsterEncounter::THE_HEART;
    }
}

#endif //COMBAT_STS_MONSTERENCOUNTER_H
